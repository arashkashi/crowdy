...
helloworld.start = function(){
	...
	var director = new lime.Director(document.body,1024,768),
        ...
        lbl = new lime.Label().setSize(160,50).setFontSize(30).setText('TOUCH ME BABY!'),
	...
	var layer_2 = new lime.Layer().setPosition(100,100);
	scene.appendChild(layer_2);

	for(var i=0;i<5;i++){
	    var box = new lime.Circle().setSize(150,150).setFill(255,150,0).setPosition(i*150,384)
	    layer_2.appendChild(box);
	}
