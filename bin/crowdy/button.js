 ...
 * @extends lime.Button
 */
crowdy.Button = function(txt) {
    lime.GlossyButton.call(this, txt);

    this.borderWidth = 4;
    this.setColor('#000');
};
goog.inherits(crowdy.Button, lime.GlossyButton);
 ...
 */
crowdy.Button.prototype.makeState_ = function() {
 ...
 */
crowdy.Button.prototype.setColor = function(clr) {
