...
crowdProject.start = function(){
	...
	circlePosition = new lime.Label().setPosition(50,50).setFontSize(20).setText('Not defined');
	...
	gameScene.appendChild(circlePosition);
    ...
    goog.events.listen(target,['mousedown','touchstart'],function(e){
        ...
        e.startDrag();
		circlePosition.setText(circle.getPosition().x)
...
crowdProject.getGameScene = function() {
